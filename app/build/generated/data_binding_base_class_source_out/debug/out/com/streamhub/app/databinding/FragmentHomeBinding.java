...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull ChipGroup chipGroupCategory, @NonNull LinearLayout layoutEmpty,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_empty_text;
      TextView tvEmptyText = ViewBindings.findChildViewById(rootView, id);
      if (tvEmptyText == null) {
        break missingId;
      }

      return new FragmentHomeBinding((CoordinatorLayout) rootView, appBar, chipGroupCategory,
          layoutEmpty, recyclerView, shimmerLayout, swipeRefresh, toolbar, tvEmptyText);
    }
